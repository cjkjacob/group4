...
# Macroeconomic Analysis - Janice Oenardi

## Week 1 - 10/14/24 ~ 10/20/24

Our group chose the Federal Reserve Economic Data (FRED) data source, with the link: <https://fred.stlouisfed.org/>, because we would like to delve more into the US economy to conduct economic analysis and financial research. Our group think that the data set contains lots of information that we can draw meaningful relationships and significance to explore. Additionally, there are a lot of different data sets under different sections, which enable us to explore different aspects of the US economy including: macroeconomic analysis, energy prices and consumption, labor market dynamics, and education spending and outcomes. 
...
mydata <- read_excel("./Final_Project/Week_3_Files/Janice/Final Project/Final_Project_copy_2.xls")
...
ggplot(mydata, aes(x = Year)) +
  ...
  labs(title = "Federal Government Receipts (in billions $) and Debt as a Percent of GDP (%)",
       x = "Year") +
