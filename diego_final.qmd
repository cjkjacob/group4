...
# Load datasets
natural_gas_data <- read.csv("./Final_Project/Week_4_Files/Diego/Weekly_Deliverables/PNRGINDEXM.csv", header = TRUE)
gas_pricing <- read.csv("./Final_Project/Week_4_Files/Diego/Weekly_Deliverables/NATURALGASD11.csv", header = TRUE)
...
sector_energy_spending <- read.csv("./Final_Project/Week_4_Files/Diego/Weekly_Deliverables/CPGREN01USM659N.csv")
