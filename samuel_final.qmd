...
earnings_data <- read_excel("./Final_Project/Week_4_Files/Samuel/week 3/Labor_Market_Dynamics_Trends_.xlsx", sheet = "Average Hourly Earnings")
inflation_data <- read_excel("./Final_Project/Week_4_Files/Samuel/week 3/Labor_Market_Dynamics_Trends_.xlsx", sheet = "CPI")
...
```{r}
# Load and clean the datasets as before
earnings_data <- read_excel("./Final_Project/Week_4_Files/Samuel/week 3/Labor_Market_Dynamics_Trends_.xlsx", sheet = "Average Hourly Earnings")
gdp_data <- read_excel("./Final_Project/Week_4_Files/Samuel/week 3/Labor_Market_Dynamics_Trends_.xlsx", sheet = "GDP")
